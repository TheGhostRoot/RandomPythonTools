...
while True:
    ...
    if fileName != "":
        print()
        isTheFileConfig = input("Is the file a config file? Y/N >> ").lower()
        print()
        isTheFileConfig = True if isTheFileConfig == "y" or isTheFileConfig == "yes" or isTheFileConfig == "da" else False
        allLangs()
        lang = input(
        ...
        if lang != "":
                ...
                if outputFileName != "":
                    print()
                    translateToAllLangs = input("Do you want to translate it to all languages? Y/N >> ").lower()
                    translateToAllLangs = True if translateToAllLangs == "y" or translateToAllLangs == "yes" or translateToAllLangs == "da" else False
                    break
...
def trans(outputFile, translator2, mt):
    langKey = getLang()
    if isTheFileConfig:
        # The file IS CONFIG
        lines = []
...
if __name__ == '__main__':
    ...
    trans(outputFile=outputFile, translator2=translator2, mt=mt)
